...
## Creación
:::caution
Tome en cuenta que estos modelos heredan de la clase Base Model, por lo que al generar ustede querer generar un inicializador, deberá hacer uso del `super().__init__(**kwargs)`
:::
